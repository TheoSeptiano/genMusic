...
let composer args = 
    ...
    //let numBars = Environment.GetCommandLineArgs() |> Seq.map System.Int32.Parse |> Seq.head
    ...
    //let numBars : int = Environment.GetCommandLineArgs() |> Seq.sumBy System.Int32.Parse

    //let numBars : int = Environment.GetCommandLineArgs() |> Array.sumBy int
